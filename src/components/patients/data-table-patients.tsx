...
const columns: ColumnDef<Patient>[] = [
  ...
  // Hidden full-text column for global search (firstName, lastName, document)
  {
    id: "q",
...
export default function PatientsTable() {
  ...
  const exportPDF = async () => {
    try {
      ...
      doc.text("Creado el día: " + new Date().toLocaleString("es-CO"), MARGIN_X + 60, 54);
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem onClick={exportExcel} className="cursor-pointer h-auto">
                  <IconFileSpreadsheet className="mr-2 h-5 w-5 text-green-700" /> Excel (.xlsx)
                </DropdownMenuItem>
                <DropdownMenuItem onClick={exportPDF} className="cursor-pointer h-auto">
                  <IconFileTypePdf className="mr-2 h-5 w-5 text-red-700" /> PDF (.pdf)
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
